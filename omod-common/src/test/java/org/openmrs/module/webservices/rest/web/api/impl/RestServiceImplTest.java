...
public class RestServiceImplTest extends BaseContextMockTest {
	...
	public void hashCode_shouldReturnSameHashcodeForEqualCompositeKeys() throws Exception {
		RestServiceImpl.CompositeSearchHandlerKey compositeKey1 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
		RestServiceImpl.CompositeSearchHandlerKey compositeKey2 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
	...
	public void equals_shouldReturnTrueIfGivenThis() throws Exception {
		RestServiceImpl.CompositeSearchHandlerKey compositeKey = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
	...
	public void equals_shouldBeTransitive() throws Exception {
		RestServiceImpl.CompositeSearchHandlerKey compositeKey1 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
		RestServiceImpl.CompositeSearchHandlerKey compositeKey2 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
		RestServiceImpl.CompositeSearchHandlerKey compositeKey3 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
		assertTrue(compositeKey1.equals(compositeKey2));
	...
	public void equals_shouldReturnFalseIfGivenACompositeKeyWithDifferentSupportedResource() throws Exception {
		RestServiceImpl.CompositeSearchHandlerKey compositeKey1 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
		RestServiceImpl.CompositeSearchHandlerKey compositeKey2 = new RestServiceImpl.CompositeSearchHandlerKey("v2/order", "default");
	...
	public void equals_shouldReturnFalseIfGivenACompositeKeyWithDifferentAdditionalKey() throws Exception {
		RestServiceImpl.CompositeSearchHandlerKey compositeKey1 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "default");
		RestServiceImpl.CompositeSearchHandlerKey compositeKey2 = new RestServiceImpl.CompositeSearchHandlerKey("v1/order", "custom");
		assertFalse(compositeKey1.equals(compositeKey2));
		assertFalse(compositeKey2.equals(compositeKey1));
	}
